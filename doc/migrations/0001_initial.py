    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(choices=[('index', 'Index'), ('redirect_url', 'Redirect_url'), ('report_malicious', 'Report_malicious'), ('click_counter', 'Click_counter'), ('contact', 'Contact')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='ExSite',
